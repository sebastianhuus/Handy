...
// Cmd/Ctrl+1–5 shortcuts for panel navigation (see App.tsx). Only the five
// always-visible sections get a shortcut/tooltip; the conditionally-visible
// `postprocessing` and `debug` sections are intentionally excluded.
...
const SidebarItem: React.FC<SidebarItemProps> = ({
  ...
  const shortcutLabel = shortcutIndex
    ? `${osType === "macos" ? "⌘" : "Ctrl+"}${shortcutIndex}`
    : null;
