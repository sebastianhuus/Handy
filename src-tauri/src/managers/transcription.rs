...
impl TranscriptionManager {
    ...
    pub fn transcribe(&self, audio: Vec<f32>) -> Result<String> {
        ...
        // still get fuzzy correction here, same as the ONNX engines. Correction
        // pairs, number-word conversion, and filler filtering all run regardless
        // of prompt support — see `post_process_transcription_text`, which also
        // backs the streaming finalize path so both get identical treatment.
        let filtered_result =
