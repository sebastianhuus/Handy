...
mod tests {
    ...
    #[test]
    fn handles_begin_quote_and_close_quote_singular() {
        assert_eq!(
            apply_quote_cues("He wrote begin quote to be or not to be close quote."),
            "He wrote \"to be or not to be\"."
        );
    }

    #[test]
    fn handles_multiple_quote_pairs_in_one_text() {
        assert_eq!(
            apply_quote_cues("She said quote hello end quote and then quote goodbye end quote."),
